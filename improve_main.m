...
image_origin=imread("origin_picture1.jpg");%加载原始图片
...
myhisteq_image_result=myhisteq(image_grayscale);
...
subplot(3,2,5);imshow(myhisteq_image_result);title('自己实现的直方图均衡化后图像：');
subplot(3,2,6);imhist(myhisteq_image_result);title('自己实现的直方图均衡化：');
